...
export interface Task02Props {
  className?: string;
}

export const Task02: React.FC<Task02Props> = (className) => {
  return (
    <div className={styles.task}>
      ...
      <ol start={0} className={styles.desc}>
        <li> The <b>Elements Panel</b>, on the left, represents the component's structure. It contains both HTML elements and components. <br/>To re-arrange the structure, you can drag elements on the panel. Let's see how to put these numbers in the correct order.</li>
        <li> To see the structure of this component, hover over <TaskSymbol name="component" /><b>Lesson02</b> and <TaskSymbol name="edit" /> edit it. </li>
