    ...
    if (solutionStatus.solved) {
      animInterval = setInterval(() => {
        ...
        if (arrowAnimIdx === arrowAnimSeq.length) {
          ...
          nextBlink[
            solutionRoutes[solutionStatus.solutionIndex][arrowAnimIdx]
          ] = true;
          setArrowAnimSeq(nextBlink);
  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.playground}>
        ...
        <ConfettiFx maxParticles={200} show={solutionStatus.solved} style={{ display: solutionStatus.solved ? 'block' : 'none'}}/>
      </div>
    </div>
  );
};
